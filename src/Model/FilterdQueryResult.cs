...
namespace Tlabs.Data.Model {
  ...
  public class QueryFilter {
    ...
    public QueryFilter(QueryFilter other) {
      ...
      if (null != other.Properties)
        Properties= new Dictionary<string, IConvertible>(other.Properties);
      if (null != other.SortAscBy)
        SortAscBy= new Dictionary<string, bool>(other.SortAscBy);
    }
  ...
  public class TimeQueryFilter : QueryFilter {
    ...
    public TimeQueryFilter() {
      ...
      this.Until= DateTime.MaxValue;
    }
    ///<summary>Default ctor.</summary>
    public TimeQueryFilter(QueryFilter qfilter) : base(qfilter) {
      this.Since= DateTime.MinValue;
      this.Until= DateTime.MaxValue;
    }
    ///<summary>Filter by <see cref="Since"/>.</summary>
    public virtual DateTime Since {
      get => Properties?[nameof(Since)] as DateTime? ?? DateTime.MinValue;
      set {
        Properties??= new Dictionary<string, IConvertible>();
        Properties[nameof(Since)]= value;
      }
    }
